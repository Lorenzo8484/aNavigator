...
- (void)rebuildSliders {
    ...
    [self mkSX:3 top:210 t:LOC(@"Tilt visuale")    mn:-180 mx:180   val:hedV fn:^(UISlider*sl){ self.mapVC.cameraHeadingOffset=sl.value; self.headV.text=[NSString stringWithFormat:@"%.0f°",sl.value]; } minL:@"-180°" midL:@"0°" maxL:@"+180°" s:&a4 l:&v4 save:@"cam_hed" cam:YES];
    ...
    [NSLayoutConstraint activateConstraints:@[
        [mbh.topAnchor constraintEqualToAnchor:self.slidersView.topAnchor constant:840],
        [mbh.leadingAnchor constraintEqualToAnchor:self.slidersView.leadingAnchor constant:4],
    ]];
    
    [self mkSX:13 top:856 t:LOC(@"Oscurità") mn:0.0 mx:1.0 val:mapBri fn:^(UISlider*sl){
