...
- (void)setupSearchOverlay {
    ...
    self.searchBlur.backgroundColor = [UIColor colorWithWhite:0.18 alpha:0.88];
    ...
    self.searchBar.searchTextField.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"Cerca indirizzo o luogo..." attributes:@{NSForegroundColorAttributeName: [UIColor colorWithWhite:0.55 alpha:1.0]}];
    self.searchBar.tintColor = [UIColor colorWithWhite:0.30 alpha:1.0];
