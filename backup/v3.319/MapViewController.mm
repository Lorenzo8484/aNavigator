...
- (void)setupSearchOverlay {
    ...
    _monthPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 62, 140)];
    ...
    // ⏰ Time picker (HH:MM) — 68pt per far stare pillola grigia
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    ...
    if (pickerView == _monthPicker) return 62;
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // Layout: 🔍 (26pt) | textField (max 90pt, sposta picker a sinistra) | dayPicker (45) | monthPicker (62) | timePicker (68)
        CGFloat tfAvailable = contW - 40 - 45 - 62 - 68 - 6;
        _searchField.frame = CGRectMake(40, 0, MAX(MIN(tfAvailable, 90), 50), 44);
        ...
        _monthPicker.frame = CGRectMake(pickersStartX + 45, -48, 62, 140);
        _timePicker.frame = CGRectMake(pickersStartX + 107, -48, 68, 140);
