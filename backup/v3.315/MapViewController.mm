...
- (void)setupSearchOverlay {
    ...
    _monthPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 70, 140)];
    ...
    // ⏰ Time picker (HH:MM) — compatto 84pt con ":"
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 84, 140)];
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    ...
    if (pickerView == _monthPicker) return 70;
    if (component == 0) return 34;  // HH
    if (component == 1) return 16;  // ":"
    return 34; // MM
}
...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component {
    ...
    UIFont *fontSmall = [UIFont systemFontOfSize:16 weight:UIFontWeightBold];
    ...
    // Time picker — stesso font per HH, ":", MM
    if (component == 1) {
        return [[NSAttributedString alloc] initWithString:@":" attributes:@{NSForegroundColorAttributeName: textColor, NSFontAttributeName: fontSmall}];
    }
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // Layout: 🔍 (26pt) | textField | dayPicker (50pt) | monthPicker (70pt) | timePicker (84pt)
        CGFloat tfWidth = contW - 40 - 50 - 70 - 84 - 12;
        ...
        _dayPicker.frame = CGRectMake(pickersStartX, -48, 50, 140);
        _monthPicker.frame = CGRectMake(pickersStartX + 52, -48, 70, 140);
        _timePicker.frame = CGRectMake(pickersStartX + 124, -48, 84, 140);
