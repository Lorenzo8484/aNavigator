...
- (void)setupButtons {
    ...
    UIView *(^makePill)(UILabel*, CGFloat, CGFloat) = ^(UILabel *label, CGFloat px, CGFloat py) {
        ...
        pill.frame = CGRectMake(px, py, 95, 55);
        ...
        label.frame = CGRectMake(4, 2, 87, 51);
...
- (void)enterLayoutEditMode {
    ...
    addItem(self.roadETAPill, @"etapill", CGRectMake(self.view.bounds.size.width - 300, self.view.bounds.size.height - 220, 95, 55));
    addItem(self.roadTimePill, @"timepill", CGRectMake(self.view.bounds.size.width - 195, self.view.bounds.size.height - 220, 95, 55));
    addItem(self.roadDistPill, @"distpill", CGRectMake(self.view.bounds.size.width - 90, self.view.bounds.size.height - 220, 95, 55));
...
- (void)loadSavedLayout {
    ...
    // 3 pillole separate ETA/Tempo/Distanza
    apply(self.roadETAPill, @"etapill", CGRectMake(w - 300, h - 220, 95, 55));
    apply(self.roadTimePill, @"timepill", CGRectMake(w - 195, h - 220, 95, 55));
    apply(self.roadDistPill, @"distpill", CGRectMake(w - 90, h - 220, 95, 55));
