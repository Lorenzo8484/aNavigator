...
- (void)setupSearchOverlay {
    ...
    // ⏰ Time picker (HH:MM) — componente unica "13:30", una pillola sola
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 58, 140)];
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    ...
    return 58; // timePicker: "23:59" a 13pt bold ≈ 36pt + padding
}
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    if (pickerView == _dayPicker) {
        ...
        // timePicker: una riga "HH:MM"
        label.text = [NSString stringWithFormat:@"%02ld:%02ld", (long)(row / 60), (long)(row % 60)];
    }
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // day(45) + month(62) + time(58) = 165pt + gap 4pt = 169pt
        CGFloat timeRightEdge = contW - 6;
        CGFloat timeX = timeRightEdge - 58;
        ...
        _timePicker.frame = CGRectMake(timeX, -48, 58, 140);
        ...
        [_timePicker selectRow:(_searchHour * 60 + _searchMin) inComponent:0 animated:NO];
