...
- (void)setupButtons {
    ...
    // 🛣️ Pill via (doppia altezza, con ETA/percorrenza/km + nome strada)
    self.roadNameLabel = [[UIView alloc] init];
    self.roadNameLabel.frame = CGRectMake(12, h - 160, w - 24, 88);
    ...
    // Riga superiore: ETA (sinistra) | Durata (centro) | Distanza (destra)
    CGFloat roadPW = w - 24;
    self.roadETALabel = [[UILabel alloc] init];
    self.roadETALabel.frame = CGRectMake(16, 6, (roadPW - 32) / 3, 24);
    self.roadETALabel.font = [UIFont systemFontOfSize:13 weight:UIFontWeightMedium];
    ...
    self.roadTimeLabel.frame = CGRectMake(16 + (roadPW - 32) / 3, 6, (roadPW - 32) / 3, 24);
    self.roadTimeLabel.font = [UIFont systemFontOfSize:13 weight:UIFontWeightMedium];
    ...
    self.roadDistLabel.frame = CGRectMake(16 + 2 * (roadPW - 32) / 3, 6, (roadPW - 32) / 3, 24);
    self.roadDistLabel.font = [UIFont systemFontOfSize:13 weight:UIFontWeightMedium];
    ...
    // Riga inferiore: nome via (nero grassetto)
    self.roadStreetLabel = [[UILabel alloc] init];
    self.roadStreetLabel.frame = CGRectMake(16, 36, roadPW - 32, 44);
    self.roadStreetLabel.font = [UIFont boldSystemFontOfSize:20];
    self.roadStreetLabel.textColor = [UIColor blackColor];
    ...
    // ⏹️ Stop button (cerchio rosso, visibile solo in navigazione)
    self.stopNavButton = [UIButton buttonWithType:UIButtonTypeCustom];
    self.stopNavButton.frame = CGRectMake(12, h - 260, 52, 52);
    ...
    self.stopNavButton.layer.cornerRadius = 26;
...
- (void)enterLayoutEditMode {
    ...
    addItem((UIView *)self.roadNameLabel, @"streetname", CGRectMake(12, self.view.bounds.size.height - 160, self.view.bounds.size.width - 24, 88));
    addItem(self.stopNavButton, @"stopnav", CGRectMake(12, self.view.bounds.size.height - 260, 52, 52));
    ...
    if (self.roadNameLabel.hidden && !self.isNavigating) {
        ...
        self.roadETALabel.text = @"14:30";
        self.roadTimeLabel.text = @"9 min";
        self.roadDistLabel.text = @"3.2 km";
...
- (void)loadSavedLayout {
    ...
    apply(self.roadNameLabel, @"streetname", CGRectMake(12, h - 160, w - 24, 88));
    apply(self.stopNavButton, @"stopnav", CGRectMake(12, h - 260, 52, 52));
