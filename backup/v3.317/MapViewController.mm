...
- (void)setupSearchOverlay {
    ...
    // 🎡 Day picker (1-31) — stretto 45pt
    _dayPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 45, 140)];
    ...
    // ⏰ Time picker (HH:MM) — compatto 68pt con ":"
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 68, 140)];
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    if (pickerView == _dayPicker) return 45;
    if (pickerView == _monthPicker) return 60;
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    if (pickerView == _dayPicker) {
        label.text = [NSString stringWithFormat:@"%02ld", (long)(row + 1)];
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // Layout: 🔍 (26pt) | textField | dayPicker (45pt) | monthPicker (60pt) | timePicker (68pt)
        CGFloat tfWidth = contW - 40 - 45 - 60 - 68 - 6;
        ...
        _dayPicker.frame = CGRectMake(pickersStartX, -48, 45, 140);
        _monthPicker.frame = CGRectMake(pickersStartX + 45, -48, 60, 140);
        _timePicker.frame = CGRectMake(pickersStartX + 105, -48, 68, 140);
