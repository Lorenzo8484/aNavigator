...
- (void)setupSearchOverlay {
    ...
    // ⏰ Time picker (HH:MM) — 2 componenti: "HH:"(42) + "MM"(32) = 74pt
...
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView *)pickerView {
    ...
    return 2; // timePicker: comp0 = "HH:"(ora), comp1 = "MM"(minuti)
}

- (NSInteger)pickerView:(UIPickerView *)pickerView numberOfRowsInComponent:(NSInteger)component {
    if (pickerView == _dayPicker) return 31; // 1-31
    if (pickerView == _monthPicker) return 12; // Gen-Dic
    if (component == 0) return 24; // ore 00-23
    return 60; // minuti 00-59
}
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    if (pickerView == _dayPicker) return 48;
    if (pickerView == _monthPicker) return 64;
    if (component == 0) return 42;  // "HH:"
    return 32; // "MM"
}
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // day(48) + month(64) + time(74) = 186pt + gap 4pt = 190pt
        CGFloat timeRightEdge = contW - 6;
        CGFloat timeX = timeRightEdge - 74;
        CGFloat monthX = timeX - 2 - 64;
        CGFloat dayX = monthX - 2 - 48;
        
        _searchField.frame = CGRectMake(40, 0, MAX(dayX - 43, 50), 44);
        _dayPicker.frame = CGRectMake(dayX, -48, 48, 140);
        _monthPicker.frame = CGRectMake(monthX, -48, 64, 140);
