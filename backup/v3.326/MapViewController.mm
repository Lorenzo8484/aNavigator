...
- (void)setupSearchOverlay {
    ...
    // ⏰ Time picker (HH:MM) — 3 componenti: HH(34) + ":"(14) + MM(34) = 82pt, HH→dx ":":center MM←sx
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 82, 140)];
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    ...
    if (component == 0) return 34;  // HH — testo allineato a destra
    if (component == 1) return 14;  // ":"
    return 34; // MM — testo allineato a sinistra
}
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    if (pickerView == _dayPicker) {
        ...
        if (component == 1) {
            ...
            label.textAlignment = NSTextAlignmentRight; // HH allineato a destra (vicino a ":")
        } else {
            label.text = [NSString stringWithFormat:@"%02ld", (long)row];
            label.textAlignment = NSTextAlignmentLeft; // MM allineato a sinistra (vicino a ":")
        }
    }
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // day(50) + month(68) + time(82) = 200pt + gap 4pt = 204pt
        CGFloat timeRightEdge = contW - 6;
        CGFloat timeX = timeRightEdge - 82;
        CGFloat monthX = timeX - 2 - 68;
        ...
        _timePicker.frame = CGRectMake(timeX, -48, 82, 140);
