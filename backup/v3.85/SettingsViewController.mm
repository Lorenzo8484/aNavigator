...
- (void)rebuildSliders {
    ...
    [self mkSX:0 top:30  t:LOC(@"Altezza")         mn:10  mx:1000 val:altV fn:^(UISlider*sl){ self.mapVC.cameraAltitude=sl.value; self.altV.text=[NSString stringWithFormat:@"%.0f m",sl.value]; } minL:@"10m" midL:@"500" maxL:@"1km" s:&a1 l:&v1 save:@"cam_alt" cam:YES];
