...
- (void)applyAllSettings {
    ...
    if ([st.poiLabels isEqualToString:@"Nessuna"]) {
        [self.webView evaluateJavaScript:@"try{map.setLayoutProperty('poi_label','visibility','none');}catch(e){} try{map.setLayoutProperty('poi','visibility','none');}catch(e){}" completionHandler:nil];
    } else {
        [self.webView evaluateJavaScript:@"try{map.setLayoutProperty('poi_label','visibility','visible');}catch(e){} try{map.setLayoutProperty('poi','visibility','visible');}catch(e){}" completionHandler:nil];
    }
    ...
    if (st.show3DBuildings) {
        [self.webView evaluateJavaScript:@"try{map.setLayoutProperty('building','visibility','visible');}catch(e){} try{map.setLayoutProperty('building-outline','visibility','visible');}catch(e){} try{map.setLayoutProperty('house','visibility','visible');}catch(e){}" completionHandler:nil];
    } else {
        [self.webView evaluateJavaScript:@"try{map.setLayoutProperty('building','visibility','none');}catch(e){} try{map.setLayoutProperty('building-outline','visibility','none');}catch(e){} try{map.setLayoutProperty('house','visibility','none');}catch(e){}" completionHandler:nil];
    }
