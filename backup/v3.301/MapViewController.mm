...
- (void)setupSearchOverlay {
    ...
    // 🎡 Day picker (rotellina su-giu)
    _dayPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 0, 75, 44)];
    ...
    // ⏰ Time picker (HH:MM)
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 0, 75, 44)];
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        CGFloat tfWidth = contW - 36 - 75 - 75 - 8;
        ...
        _dayPicker.frame = CGRectMake(pickersStartX, 0, 75, 44);
        _timePicker.frame = CGRectMake(pickersStartX + 75 + 2, 0, 75, 44);
