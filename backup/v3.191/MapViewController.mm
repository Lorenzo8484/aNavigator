...
- (void)setupButtons {
    ...
    // 🛣️ Pill via (115pt: 35% più alta, valore grande + etichetta sotto)
    self.roadNameLabel = [[UIView alloc] init];
    self.roadNameLabel.frame = CGRectMake(12, h - 420, w - 24, 115);
    ...
    // Riga superiore: ETA (sinistra) | Durata (centro) | Distanza (destra) — valore grande + etichetta sotto
    CGFloat roadPW = w - 24;
    self.roadETALabel = [[UILabel alloc] init];
    self.roadETALabel.frame = CGRectMake(16, 4, (roadPW - 32) / 3, 54);
    self.roadETALabel.numberOfLines = 2;
    self.roadETALabel.font = [UIFont boldSystemFontOfSize:33];
    ...
    self.roadTimeLabel.frame = CGRectMake(16 + (roadPW - 32) / 3, 4, (roadPW - 32) / 3, 54);
    self.roadTimeLabel.numberOfLines = 2;
    self.roadTimeLabel.font = [UIFont boldSystemFontOfSize:33];
    ...
    self.roadDistLabel.frame = CGRectMake(16 + 2 * (roadPW - 32) / 3, 4, (roadPW - 32) / 3, 54);
    self.roadDistLabel.numberOfLines = 2;
    self.roadDistLabel.font = [UIFont boldSystemFontOfSize:33];
    ...
    // Riga inferiore: nome via (bianco, centrato, subito sotto i valori)
    self.roadStreetLabel = [[UILabel alloc] init];
    self.roadStreetLabel.frame = CGRectMake(12, 62, roadPW - 24, 47);
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (etaVal) {
                ...
                [etaAttr appendAttributedString:[[NSAttributedString alloc] initWithString:etaStr attributes:@{
                    NSFontAttributeName: [UIFont boldSystemFontOfSize:33], NSForegroundColorAttributeName: [UIColor whiteColor]
                }]];
                [etaAttr appendAttributedString:[[NSAttributedString alloc] initWithString:@"\narrivo" attributes:@{
                    NSFontAttributeName: [UIFont systemFontOfSize:12], NSForegroundColorAttributeName: [UIColor colorWithWhite:0.80 alpha:1.0]
                }]];
...
- (void)enterLayoutEditMode {
    ...
    addItem((UIView *)self.roadNameLabel, @"streetname", CGRectMake(12, self.view.bounds.size.height - 420, self.view.bounds.size.width - 24, 115));
...
- (void)loadSavedLayout {
    ...
    apply(self.roadNameLabel, @"streetname", CGRectMake(12, h - 420, w - 24, 115));
