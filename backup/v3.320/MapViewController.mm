...
- (void)setupSearchOverlay {
    ...
    // ⏰ Time picker (HH:MM) — 74pt per pillola grigia che contiene HH:MM intero
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 74, 140)];
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // Layout: 🔍 (26pt) | textField (riempie) | picker allineati a DESTRA per usare spazio vuoto
        // dayPicker(45) + monthPicker(62) + timePicker(74) = 181pt + gap 4pt = 185pt
        CGFloat timeRightEdge = contW - 6;
        CGFloat timeX = timeRightEdge - 74;
        CGFloat monthX = timeX - 2 - 62;
        CGFloat dayX = monthX - 2 - 45;
        
        _searchField.frame = CGRectMake(40, 0, MAX(dayX - 43, 50), 44);
        _dayPicker.frame = CGRectMake(dayX, -48, 45, 140);
        _monthPicker.frame = CGRectMake(monthX, -48, 62, 140);
        _timePicker.frame = CGRectMake(timeX, -48, 74, 140);
