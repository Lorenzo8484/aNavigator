...
- (void)setupButtons {
    ...
    self.roadNameLabel.textColor = [UIColor colorWithRed:0.2 green:0.6 blue:1.0 alpha:1.0];
    self.roadNameLabel.font = [UIFont systemFontOfSize:16 weight:UIFontWeightMedium];
    ...
    if ([message.name isEqualToString:@"speak"]) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            if (streetName && streetName.length > 0) {
                self.roadNameLabel.text = streetName;
                self.roadNameLabel.hidden = NO;
