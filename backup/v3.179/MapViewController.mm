...
- (void)startNavigationTo:(NSDictionary *)destinationDict {
    ...
    // Mostra pill via con fade-in (nessun slide)
...
- (void)enterLayoutEditMode {
    ...
    addItem((UIView *)self.roadNameLabel, @"streetname", CGRectMake(12, self.view.bounds.size.height - 120, self.view.bounds.size.width - 24, 44));
...
- (void)loadSavedLayout {
    ...
    apply(self.roadNameLabel, @"streetname", CGRectMake(12, h - 120, w - 24, 44));
