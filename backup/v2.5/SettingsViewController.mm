...
- (void)rebuildSliders {
    ...
    float mapBright2=[ud2 objectForKey:@"map_brightness"]?[ud2 floatForKey:@"map_brightness"]:1.0;
    [self mkSX:13 top:290 t:LOC(@"Luminosita") mn:0.0 mx:1.0 val:mapBright2 fn:^(UISlider*sl){
        NSString *js2=[NSString stringWithFormat:@"setMapBrightness(%f)",sl.value];
        [self.mapVC.webView evaluateJavaScript:js2 completionHandler:nil];
    } minL:LOC(@"Chiaro") midL:@"" maxL:LOC(@"Scuro") s:&a13 l:&v13 save:@"map_brightness" cam:NO];
