...
- (void)setupSearchOverlay {
    ...
    // ⏰ Time picker (HH:MM) — 2 componenti: "HH:"(56) + "MM"(44) = 100pt
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    ...
    if (component == 0) return 56;  // "HH:" — largo per far stare pillola
    return 44; // "MM" — largo per far stare i minuti nella pillola
}
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // day(50) + month(68) + time(100) = 218pt + gap 4pt = 222pt
        CGFloat timeRightEdge = contW - 6;
        CGFloat timeX = timeRightEdge - 100;
        ...
        _timePicker.frame = CGRectMake(timeX, -48, 100, 140);
