...
- (void)setupSearchOverlay {
    ...
    // 🎡 Day picker (1-31) — stretto 40pt
    _dayPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 40, 140)];
    ...
    // 📅 Month picker (Gen-Dic) — stretto 55pt
    _monthPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 55, 140)];
    ...
    // ⏰ Time picker (HH:MM) — compatto 64pt con ":"
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 64, 140)];
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    if (pickerView == _dayPicker) return 40;
    if (pickerView == _monthPicker) return 55;
    if (component == 0) return 28;  // HH
    if (component == 1) return 8;  // ":"
    return 28; // MM
}
...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component {
    ...
    // Time picker — stesso font identico per HH, ":", MM
    if (component == 1) {
        return [[NSAttributedString alloc] initWithString:@":" attributes:@{NSForegroundColorAttributeName: textColor, NSFontAttributeName: font}];
    }
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // Layout: 🔍 (26pt) | textField | dayPicker (40pt) | monthPicker (55pt) | timePicker (64pt)
        CGFloat tfWidth = contW - 40 - 40 - 55 - 64 - 6;
        _searchField.frame = CGRectMake(40, 0, MAX(tfWidth, 50), 44);
        
        // Day picker a destra del textField
        CGFloat pickersStartX = CGRectGetMaxX(_searchField.frame) + 3;
        _dayPicker.frame = CGRectMake(pickersStartX, -48, 40, 140);
        _monthPicker.frame = CGRectMake(pickersStartX + 40, -48, 55, 140);
        _timePicker.frame = CGRectMake(pickersStartX + 95, -48, 64, 140);
