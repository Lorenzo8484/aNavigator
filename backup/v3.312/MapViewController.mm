...
- (void)setupSearchOverlay {
    ...
    // 🎡 Day picker (rotellina su-giu, stile orologio) - frame alto, niente transform
    _dayPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 100, 140)];
    ...
    // ⏰ Time picker (HH:MM) - largo 160pt per vedere 00-23 e 00-59
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 160, 140)];
...
#pragma mark - Picker Delegates (Day + Time)

- (NSInteger)numberOfComponentsInPickerView:(UIPickerView *)pickerView {
    if (pickerView == _dayPicker) return 1;
    return 2; // timePicker: HH, MM
}

- (NSInteger)pickerView:(UIPickerView *)pickerView numberOfRowsInComponent:(NSInteger)component {
    if (pickerView == _dayPicker) return 7; // Lun-Sab-Dom
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    if (pickerView == _dayPicker) return 100;
    return 75; // 2 colonne in 160pt: 75 + 75 = 150pt (spazio per padding)
}
...
- (NSAttributedString *)pickerView:(UIPickerView *)pickerView attributedTitleForRow:(NSInteger)row forComponent:(NSInteger)component {
    ...
    if (pickerView == _dayPicker) {
        NSArray *days = @[@"Lun", @"Mar", @"Mer", @"Gio", @"Ven", @"Sab", @"Dom"];
        text = days[row];
    } else {
        text = [NSString stringWithFormat:@"%02ld", (long)row];
    }
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // Layout: 🔍 (26pt) | textField | dayPicker (100pt) | timePicker (160pt)
        CGFloat tfWidth = contW - 40 - 100 - 160 - 8;
        ...
        _dayPicker.frame = CGRectMake(pickersStartX, -48, 100, 140);
        _timePicker.frame = CGRectMake(pickersStartX + 102, -48, 160, 140);
        
        [_dayPicker selectRow:_selectedDayIndex inComponent:0 animated:NO];
