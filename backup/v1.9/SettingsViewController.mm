...
- (void)sliderChanged:(UISlider*)sl {
    ...
    if(vl){
        ...
        // Tags 0-3 (camera): format handled by fn block (m or ° as appropriate)
        // Tags 5,7 (theme): format handled by fn block
        // Tags 8,9 (bus Y/X): format handled by fn block (no suffix, plain number)
