...
- (void)setupSearchOverlay {
    ...
    self.searchBlur.backgroundColor = [UIColor colorWithWhite:0.38 alpha:0.92];
    ...
    self.searchResultsTable.backgroundColor = [UIColor colorWithWhite:0.38 alpha:1.0];
...
- (void)openSearch {
    ...
    self.searchOverlay.backgroundColor = [UIColor colorWithWhite:0.38 alpha:1.0];
    self.searchBlur.backgroundColor = [UIColor colorWithWhite:0.38 alpha:1.0];
