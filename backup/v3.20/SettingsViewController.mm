...
- (void)rebuildSliders {
    ...
    [self mkSX:3 top:210 t:LOC(@"Tilt visuale")    mn:-180 mx:180   val:hedV fn:^(UISlider*sl){ 
        ...
        // Solo rotazione, senza spostare centro
        [self.mapVC.webView evaluateJavaScript:[NSString stringWithFormat:@"map.easeTo({bearing:%f, duration:200});", self.mapVC.cameraHeadingOffset] completionHandler:nil];
