...
- (void)setupButtons {
    ...
    self.roadETALabel.frame = CGRectMake(16, 2, (roadPW - 32) / 3, 65);
    ...
    self.roadETALabel.textAlignment = NSTextAlignmentCenter;
    self.roadETALabel.text = @"";
    [self.roadNameLabel addSubview:self.roadETALabel];
    
    self.roadTimeLabel = [[UILabel alloc] init];
    self.roadTimeLabel.frame = CGRectMake(16 + (roadPW - 32) / 3, 2, (roadPW - 32) / 3, 65);
    ...
    self.roadDistLabel.frame = CGRectMake(16 + 2 * (roadPW - 32) / 3, 2, (roadPW - 32) / 3, 65);
    ...
    self.roadDistLabel.textAlignment = NSTextAlignmentCenter;
    ...
    self.roadStreetLabel.frame = CGRectMake(12, 69, roadPW - 24, 40);
