...
- (void)setupSearchOverlay {
    ...
    // ⏰ Time picker (HH:MM) — 55pt, contenuto stretto
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 55, 140)];
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    ...
    if (component == 0) return 22;  // HH
    if (component == 1) return 11;  // ":"
    return 22; // MM
}
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // Layout: 🔍 (26pt) | textField | dayPicker (40) | monthPicker (55) | timePicker (55)
        CGFloat tfWidth = contW - 40 - 40 - 55 - 55 - 6;
        ...
        _timePicker.frame = CGRectMake(pickersStartX + 95, -48, 55, 140);
