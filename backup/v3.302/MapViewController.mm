...
- (void)setupSearchOverlay {
    ...
    _dayPicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 80, 140)];
    ...
    // ⏰ Time picker (HH:MM)
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 85, 140)];
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        CGFloat tfWidth = contW - 36 - 80 - 85 - 8;
        ...
        _dayPicker.frame = CGRectMake(pickersStartX, -48, 80, 140);
        _timePicker.frame = CGRectMake(pickersStartX + 82, -48, 85, 140);
