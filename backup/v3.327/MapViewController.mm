...
- (void)setupSearchOverlay {
    ...
    // ⏰ Time picker (HH:MM) — 3 componenti: HH(40) + ":"(16) + MM(40) = 96pt
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 96, 140)];
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    ...
    if (component == 0) return 40;  // HH — largo per far stare la pillola
    if (component == 1) return 16;  // ":"
    return 40; // MM — largo per far stare i minuti nella pillola
}
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // day(50) + month(68) + time(96) = 214pt + gap 4pt = 218pt
        CGFloat timeRightEdge = contW - 6;
        CGFloat timeX = timeRightEdge - 96;
        ...
        _timePicker.frame = CGRectMake(timeX, -48, 96, 140);
