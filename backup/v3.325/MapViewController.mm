...
- (void)setupSearchOverlay {
    ...
    // ⏰ Time picker (HH:MM) — 3 componenti: HH(36) + ":"(16) + MM(36) = 88pt
    _timePicker = [[UIPickerView alloc] initWithFrame:CGRectMake(0, -48, 88, 140)];
...
- (void)openSearch {
    ...
    if (isBus) {
        ...
        // day(50) + month(68) + time(88) = 206pt + gap 4pt = 210pt
        CGFloat timeRightEdge = contW - 6;
        CGFloat timeX = timeRightEdge - 88;
        ...
        _timePicker.frame = CGRectMake(timeX, -48, 88, 140);
