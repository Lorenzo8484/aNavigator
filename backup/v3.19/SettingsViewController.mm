...
- (void)rebuildSliders {
    ...
    [self mkSX:3 top:210 t:LOC(@"Tilt visuale")    mn:0   mx:85   val:hedV fn:^(UISlider*sl){ self.mapVC.cameraPitch=90-sl.value; self.headV.text=[NSString stringWithFormat:@"%.0f°",sl.value]; } minL:@"0°" midL:@"45°" maxL:@"85°" s:&a4 l:&v4 save:@"cam_pit" cam:YES];
